...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.meta_description'
        db.add_column(u'blog_post', 'meta_description',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.meta_description'
        db.delete_column(u'blog_post', 'meta_description')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'meta_description': ('django.db.models.fields.CharField', [], {'max_length': '350', 'blank': 'True'}),
